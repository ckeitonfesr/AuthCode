...
function cors(req, res) {
  ...
  res.setHeader('Access-Control-Allow-Headers',
    'Content-Type, x-request-token, x-device-id, x-app-key, x-timestamp, x-signature, x-user-token, x-webhook-secret, x-app-platform, x-integrity-token, x-integrity-nonce'
  );
